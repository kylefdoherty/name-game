...
RSpec.describe TeammatesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all teammates as @teammates" do
      ...
      expect(assigns(:teammates)).to eq([teammate])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested teammate as @teammate" do
      teammate = Teammate.create! valid_attributes
      get :show, {:id => teammate.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested teammate as @teammate" do
      teammate = Teammate.create! valid_attributes
      get :edit, {:id => teammate.to_param}, valid_session
      expect(assigns(:teammate)).to eq(teammate)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Teammate" do
        expect {
          post :create, {:teammate => valid_attributes}, valid_session
        }.to change(Teammate, :count).by(1)
      end

      it "assigns a newly created teammate as @teammate" do
        post :create, {:teammate => valid_attributes}, valid_session
        expect(assigns(:teammate)).to be_a(Teammate)
        expect(assigns(:teammate)).to be_persisted
      end

      it "redirects to the created teammate" do
        post :create, {:teammate => valid_attributes}, valid_session
        expect(response).to redirect_to(Teammate.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved teammate as @teammate" do
        post :create, {:teammate => invalid_attributes}, valid_session
        expect(assigns(:teammate)).to be_a_new(Teammate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested teammate" do
        teammate = Teammate.create! valid_attributes
        put :update, {:id => teammate.to_param, :teammate => new_attributes}, valid_session
        teammate.reload
      ...
      it "assigns the requested teammate as @teammate" do
        teammate = Teammate.create! valid_attributes
        put :update, {:id => teammate.to_param, :teammate => valid_attributes}, valid_session
        expect(assigns(:teammate)).to eq(teammate)
      end
    ...
    describe "with invalid params" do
      it "assigns the teammate as @teammate" do
        teammate = Teammate.create! valid_attributes
        put :update, {:id => teammate.to_param, :teammate => invalid_attributes}, valid_session
        expect(assigns(:teammate)).to eq(teammate)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested teammate" do
      teammate = Teammate.create! valid_attributes
      expect {
        delete :destroy, {:id => teammate.to_param}, valid_session
      }.to change(Teammate, :count).by(-1)
    end
    ...
    it "redirects to the teammates list" do
      teammate = Teammate.create! valid_attributes
      delete :destroy, {:id => teammate.to_param}, valid_session
      expect(response).to redirect_to(teammates_url)
    end
  end
